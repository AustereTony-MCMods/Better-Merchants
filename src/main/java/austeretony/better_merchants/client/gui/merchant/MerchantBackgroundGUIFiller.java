...
public class MerchantBackgroundGUIFiller extends BackgroundGUIFiller {
    ...
    public void drawDefaultBackground() {
        ...
        drawRect(0, 14, 70, 23, GUISettings.instance().getAdditionalGUIBackgroundColor());//search field background
        drawRect(71, 14, this.getWidth(), 23, GUISettings.instance().getAdditionalGUIBackgroundColor());//dummy line background
