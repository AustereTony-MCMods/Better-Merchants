...
public class SellingGUISection extends AbstractGUISection {
    ...
    public void init() {
        ...
        String sectionName = ClientReference.localize("better_merchants.gui.merchant.selling");
        ...
        this.addElement(this.buySectionButton = new GUIButton(this.getWidth() - 28, 0, 12, 12).setSound(SoundEffects.BUTTON_CLICK.soundEvent).setTexture(MerchantsGUITextures.BUY_ICONS, 12, 12));  
        this.addElement(new GUIButton(this.getWidth() - 14, 0, 12, 12).setTexture(MerchantsGUITextures.SELL_ICONS, 12, 12).toggle());    
