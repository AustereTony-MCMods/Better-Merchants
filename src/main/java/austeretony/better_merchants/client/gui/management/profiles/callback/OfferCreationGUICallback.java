...
public class OfferCreationGUICallback extends AbstractGUICallback {
    ...
    public void init() {
        ...
        this.addElement(new GUITextLabel(2, 2).setDisplayText(ClientReference.localize("better_merchants.gui.management.offerCreationCallback"), true, GUISettings.instance().getTitleScale()));

        this.addElement(new GUITextLabel(2, 98).setDisplayText(ClientReference.localize("better_merchants.gui.management.amount"), true, GUISettings.instance().getSubTextScale()));
        ...
        this.addElement(new GUITextLabel(2, 118).setDisplayText(ClientReference.localize("better_merchants.gui.management.cost"), true, GUISettings.instance().getSubTextScale()));
        ...
        this.addElement(this.enableSellingButton = new GUICheckBoxButton(2, 139, 6).setSound(SoundEffects.BUTTON_CLICK.soundEvent)
        ...
        this.addElement(new GUITextLabel(12, 138).setDisplayText(ClientReference.localize("better_merchants.gui.management.enableSelling"), true, GUISettings.instance().getSubTextScale()));
        ...
        this.addElement(this.sellingOnlyButton = new GUICheckBoxButton(2, 159, 6).setSound(SoundEffects.BUTTON_CLICK.soundEvent)
        ...
        this.addElement(new GUITextLabel(12, 158).setDisplayText(ClientReference.localize("better_merchants.gui.management.sellingOnly"), true, GUISettings.instance().getSubTextScale()));
