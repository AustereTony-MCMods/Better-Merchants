...
public class OfferEditingGUICallback extends AbstractGUICallback {
    ...
    public void init() {
        ...
        this.addElement(new GUITextLabel(2, 2).setDisplayText(ClientReference.localize("better_merchants.gui.management.offerEditingCallback"), true, GUISettings.instance().getTitleScale()));
        ...
        this.addElement(this.sellingOnlyButton = new GUICheckBoxButton(2, 161, 6).setSound(SoundEffects.BUTTON_CLICK.soundEvent)
        ...
        this.addElement(new GUITextLabel(12, 160).setDisplayText(ClientReference.localize("better_merchants.gui.management.sellingOnly"), true, GUISettings.instance().getSubTextScale()));
