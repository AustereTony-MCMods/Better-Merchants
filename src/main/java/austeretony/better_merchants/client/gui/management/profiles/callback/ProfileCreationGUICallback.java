...
public class ProfileCreationGUICallback extends AbstractGUICallback {
    ...
    public void init() {
        ...
        this.addElement(new GUITextLabel(2, 2).setDisplayText(ClientReference.localize("better_merchants.gui.management.profileCreationCallback"), true, GUISettings.instance().getTitleScale()));   
    ...
    public void handleElementClick(AbstractGUISection section, GUIBaseElement element, int mouseButton) {
        if (mouseButton == 0) { 
            if (element == this.cancelButton)
                ...
                String name = this.nameField.getTypedText().isEmpty() ? I18n.format("better_merchants.gui.management.profileGenericName") 
